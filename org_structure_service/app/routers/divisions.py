...
@router.post("/{team_id}/divisions", dependencies=[AdminAndAssigned], summary="Создание дивизии")
...
@router.patch("/{team_id}/divisions/{division_id}", dependencies=[AdminAndAssigned], summary="Обновление дивизии")
...
@router.delete("/{team_id}/divisions/{division_id}", dependencies=[AdminAndAssigned], summary="Удаление дивизии")
