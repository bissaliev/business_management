...
async def add_comment(
    ...
    return await comment_service.create_comment(task_id, user, comment_data.model_dump())
...
async def update_comment(
    ...
    return await comment_service.update_comment(task_id, comment_id, user, comment_data.model_dump(exclude_unset=True))
...
async def delete_comment(
    ...
    await comment_service.delete_comment(task_id, comment_id)
