...
@router.patch("/{task_id}", dependencies=[AssigneePermission], summary="Обновление задачи")
...
@router.delete("/{task_id}", dependencies=[AssigneePermission], summary="Удаление выполненной задачи")
async def delete_task(task_id: int, user: ManagerOrAdmin, task_service: TaskServiceDeps) -> MessageDelete:
