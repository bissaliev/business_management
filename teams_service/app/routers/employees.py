...
@router.post("/{team_id}/employees/", dependencies=[AdminDeps], summary="Регистрация сотрудника")
...
@router.get(
    "/{team_id}/employees/", dependencies=[AdminDeps], summary="Получение всех сотрудников определенной команды"
)
...
@router.patch("/{team_id}/employees/{employee_id}", dependencies=[AdminDeps], summary="Обновление роли работника")
...
@router.delete("/{team_id}/employees/{employee_id}", dependencies=[AdminDeps], summary="Удаление сотрудника")
