...
@router.get("/{team_id}/news", dependencies=[AdminDeps], summary="Получение списка новостей команды")
...
@router.post("/{team_id}/news", dependencies=[AdminDeps], summary="Создание новости команды")
...
@router.get("/{team_id}/news/{id}", dependencies=[AdminDeps], summary="Получение одной новости команды по id")
...
@router.put("/{team_id}/news{id}", dependencies=[AdminDeps], summary="Обновление данных новости команды")
...
@router.delete("/{team_id}/news{id}", dependencies=[AdminDeps], summary="Удаление данных новости команды")
