...
async def create_team(
    ...
    return await team_news_service.create_news(team_id, news_data.model_dump())
...
async def update_team_news(
    ...
    return await team_news_service.update_news(team_id, id, update_data.model_dump(exclude_unset=True))
